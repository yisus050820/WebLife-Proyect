        ...
        if ($thumbnail['name']) {
            ...
            if (in_array($extension, $allowed_files)) {
                ...
                if ($thumbnail['size'] < 2000000) {
                    ...
                    $_SESSION['edit-post'] = "No se pudo actualizar la publicación. El tamaño de la miniatura es demasiado grande. Debe ser menos de 2mb";
                }
            } else {
                $_SESSION['edit-post'] = "No se pudo actualizar la publicación. La miniatura debe ser png, jpg o jpeg.";
            }
        }
    }
